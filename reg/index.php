...
<form id="reg" action="register.php" method="post" onsubmit="return chk_form();">
  <table width="100%" height="90%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td width="30%" background=""><h2>SCIS账号注册</h2>
	   <table width="70%" height="20%"  border="0" align="center" cellpadding="1" cellspacing="1" bordercolorlight="#888888" bordercolordark="#888888">
		...
		<tr>&nbsp;</tr>
		<tr align="left">
          <td height="30">输入你的名字:<input type="text" class="input" name="username" id="user"></td>
        </tr>
		<tr align="left">
          <td height="30">输入你的密码:<input type="password" class="input" name="password" id="pass"></td>
        </tr>
		<!--
		<tr align="left">
          <td height="30">确认你的密码:<input type="password" class="input" name="enterpwd" id="enterpwd"></td>
        </tr>
		-->
		<tr align="left">
