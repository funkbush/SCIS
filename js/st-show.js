...
function showPic(stock,date)   //显示jpgraph生成的图片
{  	
...
{
    document.getElementById("jymx").innerHTML="";
	
	var xmlhttp;  //新建一个XHR变量，用于和服务器交换数据  等价于create XMLHttpRequest();
	
	var stock=document.getElementById("stock").value;  //得到当前股票
    var date=document.getElementById("date").value;  //得到当前日期
	
	document.title="SCIS "+stock+"分笔明细";
